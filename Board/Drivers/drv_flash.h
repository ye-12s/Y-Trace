...
#define FLASH_FILESYSTEM_START_ADDR (FLASH_BASE_ADDR + SECTOR_SIZE * 256) // upper 512KB for filesystem
#define FLASH_FILESYSTEM_SIZE       (SECTOR_SIZE * 256)                   // 256 sectors for filesystem
